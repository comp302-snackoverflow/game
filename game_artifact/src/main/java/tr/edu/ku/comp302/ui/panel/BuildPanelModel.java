...
public class BuildPanelModel {
    ...
    public void countBarriers(HashMap<List<Double>, Barrier> barriers) {
        int firmCount = 0;
        int simpleCount = 0;
...
//        int giftCount = 0;
        ...
        public HashMap<List<Double>, Barrier> generateRandomMap(ArrayList<Double> xIndices, ArrayList<Double> yIndices, int simpleNum, int explosiveNum, int giftNum, int firmNum) {
            HashMap<List<Double>, Barrier> newMap = new HashMap<>();
...
//            generateRandomBarrierType(newMap, xCopy, yCopy, firmNum, "firm");
        ...
        // Deprecated. Cannot be fixed
//        public void generateRandomBarrierType (HashMap<List<Double>, Barrier> barrierMap, ArrayList<Double> xIndices, ArrayList<Double> yIndices, int barrierNum, String barrierType) {
//
//
...
//    public void scaleBarrierImages(Barrier barrierView){
